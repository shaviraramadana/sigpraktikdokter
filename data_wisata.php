  ...
  <div class="container">
    <div class="row d-flex align-items-center justify-content-center">
      <div class="about-content col-lg-12">
        <h1 class="text-white">
          Data Lokasi Dokter Praktik
        </h1>
        <p class="text-white link-nav">Halaman ini memuat informasi Lokasi Dokter Praktik Di Kacamatan Lalabata Kabupaten Soppeng</p>
      </div>
    </div>
  </div>
</section>
            ...
            <div class="panel-body">
              <table class="table table-bordered table-striped table-admin">
                <thead>
                  <tr>
                    <th width="5%">No.</th>
                    <th width="30%">Nama Dokter Praktik</th>
                ...
                <tbody>
                  <?php
                  $data = file_get_contents('http://localhost/SIG-PRAKTIKDOKTER/ambildata.php');
                  $no = 1;
