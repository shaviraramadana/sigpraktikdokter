...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>SIG LOKASI DOKTER PRAKTIK</title>

	<link rel="icon" href="admin/img/logodokter.png">
	...
	<header id="header">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="admin/img/logodokter.png" width="50px" height="50px" alt="" title="" /></a>
				</div>
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						<li><a href="index.php">Home</a></li>
						<li><a href="data_wisata.php">Data Lokasi Dokter Praktik</a></li>
